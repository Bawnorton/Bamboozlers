...
{
    public static readonly PacketType<MessageEditedS2CPacket> Type = PacketType<MessageEditedS2CPacket>.Create("message_edited_s2c", json => new MessageEditedS2CPacket(json));
